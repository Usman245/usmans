            ...
            >
              ...
              >
                <div className="text-3xl md:text-5xl mb-2 p-1  ">
                  <Image src='/html.png' height={40} width={40} alt='html'
                    
                    style={{color: 'rgb(227, 79, 38)', width: '40px', height: '40px'}}/>
                </div>
              ...
              >
                <div className="text-3xl md:text-5xl mb-2 p-1  ">
                  <svg
                    ...
                    height="1em"
                    viewBox="0 0 512 128"
                    style={{color: 'rgb(49, 120, 198)', width: '40px', height: '40px'}}
                  >
                    <path
                      fill="#3178C6"
              ...
              >
                <div className="text-3xl md:text-5xl mb-2 p-1  ">
                  <svg
                    ...
                    height="1em"
                    viewBox="0 0 256 288"
                    style={{color: 'rgb(0, 89, 156)', width: '40px', height: '40px'}}
                  >
                    <path
                      fill="#649AD2"
              ...
              >
                <div className="text-3xl md:text-5xl mb-2 p-1  ">
                  <svg
                    ...
                    height="1em"
                    viewBox="0 0 256 346"
                    style={{color: 'rgb(0, 115, 150)', width: '40px', height: '40px'}}
                  >
                    <path
                      fill="#5382A1"
              ...
              >
                <div className="text-3xl md:text-5xl mb-2 p-1  ">
                  <svg
                    ...
                    height="1em"
                    viewBox="0 0 256 228"
                    style={{color: 'rgb(97, 218, 251)', width: '40px', height:'40px'}}
                  >
                    <path
                      fill="#00D8FF"
              ...
              >
                <div className="text-3xl md:text-5xl mb-2 p-1  ">
                  <svg
                    ...
                    height="1em"
                    viewBox="0 0 512 314"
                    style={{color: 'rgb(104, 160, 99)', width: '40px', height: '40px'}}
                  >
                    <defs>
                      <linearGradient
                        id="iconifyReact0"
              ...
              >
                <div className="text-3xl md:text-5xl mb-2 p-1  ">
                  <svg
                    ...
                    height="1em"
                    viewBox="0 0 512 104"
                    style={{color: 'rgb(0, 0, 0)', width: '40px', height: '40px;'}}
                  >
              ...
              >
                <div className="text-3xl md:text-5xl mb-2 p-1  ">
                  <svg
                    ...
                    height="1em"
                    viewBox="0 0 256 108"
                    style={{color: 'rgb(240, 80, 50)', width: '40px', height: '40px'}}
                  >
                    <path
                      fill="#2F2707"
              ...
              >
                <div className="text-3xl md:text-5xl mb-2 p-1  ">
                  <svg
                    ...
                    height="1em"
                    viewBox="0 0 512 131"
                    style={{color: 'rgb(36, 150, 237)', width: '40px', height: '40px'}}
                  >
                    <path
                      fill="#2396ED"
              ...
              >
                <div className="text-3xl md:text-5xl mb-2 p-1  ">
                  <svg
                    ...
                    height="1em"
                    viewBox="0 0 256 290"
                    style={{color: 'rgb(141, 214, 249)', width: '40px', height: '40px'}}
                  >
                    <path
                      fill="#FFF"
              ...
              >
                <div className="text-3xl md:text-5xl mb-2 p-1  ">
                  <svg
                    ...
                    height="1em"
                    viewBox="0 0 512 165"
                    style={{color: 'rgb(203, 56, 55)', width: '40px', height: '40px'}}
                  >
                    <path
                      fill="#C12127"
              ...
              >
                <div className="text-3xl md:text-5xl mb-2 p-1  ">
                  <svg
                    ...
                    height="1em"
                    viewBox="0 0 256 256"
                    style={{color: 'rgb(44, 142, 187)', width: '40px', height: '40px'}}
                  >
                    <path
                      fill="#368FB9"
              ...
              >
                <div className="text-3xl md:text-5xl mb-2 p-1  ">
                  <svg
                    ...
                    height="1em"
                    viewBox="0 0 512 156"
                    style={{color: 'rgb(255, 108, 55)', width: '40px', height:'40px'}}
                  >
                    <path
                      fill="#FF6C37"
              ...
              >
                <div className="text-3xl md:text-5xl mb-2 p-1  ">
                  <svg
                    ...
                    height="1em"
                    viewBox="0 0 256 153"
                    style="color: rgb(255, 153, 0); width: 40px; height: 40px;"
                  >
                    <path
                      fill="#252F3E"
              ...
              >
                <div className="text-3xl md:text-5xl mb-2 p-1  ">
                  <svg
                    ...
                    height="1em"
                    viewBox="0 0 256 351"
                    style={{color: 'rgb(255, 203, 43)', width: '40px', height: '40px'}}
                  >
                    <defs>
                      <filter
                        id="iconifyReact9"
              ...
              >
                <div className="text-3xl md:text-5xl mb-2 p-1  ">
                  <svg
                    ...
                    height="1em"
                    viewBox="0 0 512 139"
                    style={{color: 'rgb(24, 23, 23)', width: '40px', height: '40px'}}
                  >
                    <path
                      fill="#11110F"
              ...
              >
                <div className="text-3xl md:text-5xl mb-2 p-1  ">
                  <svg
                    ...
                    height="1em"
                    viewBox="0 0 512 135"
                    style={{color: 'rgb(71, 162, 72)', width: '40px', height: '40px'}}
                  >
                    <path
                      fill="#01EC64"
              ...
              >
                <div className="text-3xl md:text-5xl mb-2 p-1  ">
                  <svg
                    ...
                    height="1em"
                    viewBox="0 0 512 349"
                    style={{color: 'rgb(68, 121, 161)', width: '40px', height:'40px'}}
                  >
                    <path
                      fill="#00758F"
              ...
              >
                <div className="text-3xl md:text-5xl mb-2 p-1  ">
                  <svg
                    ...
                    height="1em"
                    viewBox="0 0 256 264"
                    style={{color: 'rgb(51, 103, 145)', width: '40px', height: '40px'}}
                  >
              ...
              >
                <div className="text-3xl md:text-5xl mb-2 p-1  ">
                  <svg
                    ...
                    height="1em"
                    viewBox="0 0 512 228"
                    style={{color: 'rgb(0, 59, 87)', width: '40px', height: '40px'}}
                  >
                    <defs>
                      <linearGradient
                        id="iconifyReact13"
              ...
              >
                <div className="text-3xl md:text-5xl mb-2 p-1  ">
                  <svg
                    ...
                    height="1em"
                    viewBox="0 0 256 288"
                    style={{color: 'rgb(225, 0, 152)', width: '40px', height: '40px'}}
                  >
                    <path
                      fill="#E535AB"
                      fill-rule="evenodd"
              ...
              >
                <div className="text-3xl md:text-5xl mb-2 p-1  ">
                  <svg
                    ...
                    height="1em"
                    viewBox="0 0 256 512"
                    style={{color: 'rgb(210, 33, 40)', width: '40px', height: '40px'}}
                  >
                    <defs>
                      <linearGradient
                        id="iconifyReact14"
                      ...
                      >
                        ...
                        <stop offset="31.23%" stop-color="#F79A23"></stop>
                        <stop offset="83.83%" stop-color="#E97826"></stop>
                      </linearGradient>
                      <linearGradient
                        id="iconifyReact15"
                        x1="-217.651%"
                        ...
                        y2="13.846%"
                      >
                        <stop offset="32.33%" stop-color="#9E2064"></stop>
                        <stop offset="63.02%" stop-color="#C92037"></stop>
                        <stop offset="75.14%" stop-color="#CD2335"></stop>
                        <stop offset="100%" stop-color="#E97826"></stop>
                      </linearGradient>
                      <linearGradient
                        id="iconifyReact16"
                        x1="-80.044%"
                      ...
                      >
                        ...
                        <stop offset="9.548%" stop-color="#662E8D"></stop>
                        <stop offset="78.82%" stop-color="#9F2064"></stop>
                        <stop offset="94.87%" stop-color="#CD2032"></stop>
                      </linearGradient>
                      <linearGradient
                        id="iconifyReact18"
                        x1="-129.783%"
              ...
              >
                <div className="text-3xl md:text-5xl mb-2 p-1  ">
                  <svg
                    ...
                    height="1em"
                    viewBox="0 0 256 249"
                    style={{color: 'rgb(50, 108, 229)', width: '40px', height: '40px'}}
                  >
                    <path
                      fill="#326DE6"
              ...
              >
                <div className="text-3xl md:text-5xl mb-2 p-1  ">
                  <svg
                    ...
                    height="1em"
                    viewBox="0 0 256 283"
                    style={{color: 'rgb(194, 19, 37)', width:'40px', height: '40px'}}
                  >
                    <path
                      fill="#99425B"
              ...
              >
                <div className="text-3xl md:text-5xl mb-2 p-1  ">
                  <svg
                    ...
                    height="1em"
                    viewBox="0 0 512 207"
                    style={{color: 'rgb(23, 32, 44)', width: '40px', height: '40px'}}
                  >
                    <defs>
                      <linearGradient
                        id="iconifyReact21"
                        ...
                        y2="66.621%"
                      >
                        <stop offset="9.39%" stop-color="#58D09E"></stop>
                        <stop
                          offset="98.83%"
                          stop-color="#58D09E"
                          stop-opacity="0"
                      ...
                      <linearGradient
                        ...
                        y2="63.329%"
                      >
                        <stop offset="7.74%" stop-color="#58D09E"></stop>
                        <stop offset="76.17%" stop-color="#1B1E2E"></stop>
                      </linearGradient>
                    </defs>
                    <path
                      fill="#69D3A7"
              ...
              >
                <div className="text-3xl md:text-5xl mb-2 p-1  ">
                  <svg
                    ...
                    height="1em"
                    viewBox="0 0 512 64"
                    style={{color: 'rgb(6, 182, 212)', width: '40px', height: '40px'}}
                  >
                    <defs>
                      <linearGradient
                        id="iconifyReact23"
              ...
              >
                <div className="text-3xl md:text-5xl mb-2 p-1  ">
                  <svg
                    ...
                    height="1em"
                    viewBox="0 0 256 384"
                    style={{color: 'rgb(242, 78, 30)', width: '40px', height: '40px'}}
                  >
                    <path
                      fill="#0ACF83"
              ...
              >
                <div className="text-3xl md:text-5xl mb-2 p-1  ">
                  <svg
                    ...
                    height="1em"
                    viewBox="0 0 256 250"
                    style={{color: 'rgb(255, 97, 246)', width: '40px', height: '40px'}}
                  >
                    <rect
                      width="256"
                      height="249.6"
